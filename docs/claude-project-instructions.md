...
This Project is for working with DNS Bhat Kannada linguistics books in the [ettuge](https://github.com/vwulf/ettuge) repository,
coining native Kannada words, Eke romanisation, morphology, and OCR cleanup.

You have five specialised skill sets. Invoke the right one automatically based on the user's request.
