---
redirect_from:
  - /dnsbhat/15-inglish-kannada-padanerake/15-inglish-kannada-padanerake-en
---

# English-Kannada Word Correspondence Dictionary
## *Inglish-Kannada Padanerake* — Native Dravidian Alternatives for English Words

**Author:** D. N. Shankara Bhat (ಡಿ. ಎನ್. ಶಂಕರ ಬಟ್), Y. Bharath Kumar (ಯೋ. ಭರತ್ ಕುಮಾರ್), Vivek Shankar (ವಿವೇಕ್ ಶಂಕರ್)
**Published:** 2015, Navakarnataka Prakashan, Bengaluru
...
- [Preface — The Problem of "Trishanku" Words](#preface)
- [Conventions Used in the Dictionary](#conventions)
- [Statistical Observations on Kannada Word Stock](#stats)
- [Word-Formation Patterns: A Thematic Index](#patterns)
  - [1. Compound Nouns (N+N)](#compound-nn)
  - [2. Descriptive Compounds (Adj+N)](#compound-adjn)
  - [3. Verb-derived Nouns (-ta, -ike, -vu, -atu)](#verb-nouns)
  - [4. Agent Nouns (-ga, -kAra, -uga)](#agent-nouns)
  - [5. Negation Prefix (il-, bella-)](#negation)
  - [6. Native Roots as Dictionary Terms](#roots)
  - [7. Compounds with ಅರಿಮೆ (arime — science/study)](#arime)
  - [8. Compounds with ಮನೆ (mane — house/institution)](#mane)
  - [9. Compounds with ಗಾಳಿ (gALi — air/wind)](#gaLi)
  - [10. Compounds with ಮಾಂಜುಗೆ/ಮಾಂಜು (therapy/treatment)](#maanju)
- [Sample Entries: A–Az](#sample)
- [Key Concept Table: Kannada Terms → English](#concepts)
- [Cross-References to Other DNS Bhat Works](#crossref)
...
- **Part-of-speech markers apply to the Kannada word**, not to the English headword. The Kannada word may differ in grammatical category from its English counterpart.
  ...
  - **ಎ** (*e*) = ಎಸಕಪದ (*esakapada*) = **verb**
  - **ಪ** (*pa*) = ಪರಿಚೆಪದ (*paricepada*) = **adjective / qualifier**
