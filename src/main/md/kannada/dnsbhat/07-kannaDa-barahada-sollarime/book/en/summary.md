---
redirect_from:
  - /dnsbhat/07-kannadada-sollarime/07-kannadada-sollarime-en
---
...
**Title (Eke):** kannaD barahada sollarime (idu kannaDigdE vyAkaraNa)
**Title (English):** A Grammar of Kannada Writing (This Is Kannada's Own Grammar)
**Author:** D. N. Shankara Bhat (ಡಿ. ಎನ್. ಶಂಕರ ಬಟ್)
**Year:** 2010 (first edition, both volumes)
**Publisher:** Baasha Prakashan (ಬಾಶಾಪ್ರಕಾಶನ), Heggodu, Sagara 577 417; phone 9900829345
**Volumes:** 2 (Volume 1: chapters 1–4; Volume 2: chapters 5–9)
**Language:** Kannada (written in hosa baraha — simplified spelling)
**Topic:** Comprehensive descriptive grammar of written Kannada (ಕನ್ನಡ ಬರಹ), systematically treating phonology, morphology, word classes, inflection, and sentence structure on Kannada-native terms, free from Sanskrit grammatical categories

---

## Book Overview

*Kannadada Sollarime* is D. N. Shankara Bhat's most comprehensive grammar of the Kannada language, focusing specifically on written Kannada (ಕನ್ನಡ ಬರಹ, "Kannada baraha"). The title translates as "A Grammar of Kannada Writing," with the subtitle "This Is Kannada's Own Grammar" (ಇದು ಕನ್ನಡದ್ದೇ ವ್ಯಾಕರಣ) pointedly declaring its distance from the Sanskrit-derived grammars that have historically been imposed on Kannada. In the preface Bhat states plainly that the "Kannada grammars" in common use are not Kannada grammars at all: instead of describing the actual rules that govern Kannada words (ಪದ), noun phrases (ಪದಕಂತೆ, padakante), and sentences (ಸೊಲ್ಲು, sollu), they try to fit Sanskrit grammatical rules onto Kannada data. The book is the culmination of a decades-long effort to write a grammar adequate to what Kannada actually does. It replaces the Sanskrit term *vyakarana* with the Kannada-native term *sollarime* — meaning roughly "deep understanding of sentences" — both to signal its methodological independence and to strip the association of grammar-learning with pointless difficulty. The book is written throughout in Bhat's preferred simplified orthography (hosa baraha), which reduces the Kannada script by eliminating several letters not needed for modern Kannada phonology.

Volume 1 lays the descriptive foundations. Chapter 1 (ಮುನ್ನೋಟ, "Preview") establishes what grammar is, why written Kannada has its own grammar distinct from spoken Kannada, and provides a complete overview of the writing system — letters, sandhi, and punctuation. Chapter 2 describes the morphological structure of nouns (ಹೆಸರುಪದ, hesarupada) including all the nominal derivational suffixes and compound noun types. Chapter 3 extends this to the remaining word classes: verbs (ಎಸಕಪದ, esakapada), qualifiers/adjectives (ಪರಿಚೆಪದ, paricepada), demonstratives, numerals, and loanwords. Chapter 4 gives a complete systematic account of inflectional morphology — verb paradigms (all 36 finite and non-finite forms), noun case endings, and the phonological rules that govern how suffixes attach to stems, including eleven major sandhi alternations.

Volume 2 turns from words to sentences. Chapter 5 treats verb usage in depth: how the 36 verb forms (and the auxiliary verbs) express tense reference, temporal aspect, and speaker stance (epistemic and deontic modality). Chapter 6 covers the structure and semantic roles of noun phrases — argument structure, case semantics, and the relationship between verbs and their semantic participants (ಪಾಂಗು, pangu). Chapter 7 analyses simple sentences (ಸುಳುಸೊಲ್ಲು) and the many ways in which sentences can be modified by adding time, place, manner, and other adjuncts. Chapter 8 covers complex sentence types: compound sentences (ಜೋಡುಸೊಲ್ಲು), embedded/complex sentences (ಅಡಕಸೊಲ್ಲು), and the special phenomena of topicalization, focus, and information structure. Chapter 9 revisits the contrast between written and spoken Kannada (ಬರಹ ಮತ್ತು ಮಾತು), exploring why writing is conservative and speech more innovative, and concludes with a defence of simplifying Kannada orthography to bring written Kannada within reach of all Kannadigas.
...
- [Chapter 1 — Preview (ಮುನ್ನೋಟ)](#chapter-1--preview)
  - [1.1 Grammar and Sollarime](#11-grammar-and-sollarime)
  - [1.2 The Many Varieties of Kannada](#12-the-many-varieties-of-kannada)
  - [1.3 Speech and Writing](#13-speech-and-writing)
  - [1.4 The Writing System](#14-the-writing-system)
  - [1.5 Sentence Structure — Overview](#15-sentence-structure--overview)
  - [1.6 Letters and Their Sounds](#16-letters-and-their-sounds)
  - [1.7 Punctuation Marks](#17-punctuation-marks)
- [Chapter 2 — Word Structure: Nouns (ಪದಗಳ ಇಟ್ಟಳ: ಹೆಸರುಪದಗಳು)](#chapter-2--word-structure-nouns)
  - [2.1 Overview](#21-overview)
  - [2.2 Sandhi Rules (ಸೇರಿಕೆಯ ಒಲವುಗಳು)](#22-sandhi-rules)
  - [2.3 Structure of Nouns](#23-structure-of-nouns)
  - [2.4 Derived Nouns (ಒಟ್ಟಿಸಿದ ಹೆಸರುಪದಗಳು)](#24-derived-nouns)
  - [2.5 Compound Words (ಜೋಡುಪದಗಳು)](#25-compound-words)
- [Chapter 3 — Word Structure: Remaining Word Classes (ಪದಗಳ ಇಟ್ಟಳ: ಉಳಿದ ಪದಗಳು)](#chapter-3--word-structure-remaining-word-classes)
  - [3.2 Verbs (ಎಸಕಪದಗಳ ಇಟ್ಟಳ)](#32-verbs)
  - [3.3 Compound Verbs (ಕೂಡುಪದಗಳು)](#33-compound-verbs)
  - [3.4 Qualifiers (ಪರಿಚೆಪದಗಳ ಇಟ್ಟಳ)](#34-qualifiers)
  - [3.5–3.6 Demonstratives, Numerals, Loanwords](#35-36-demonstratives-numerals-loanwords)
- [Chapter 4 — Inflectional Forms (ಪದರೂಪಗಳ ಇಟ್ಟಳ)](#chapter-4--inflectional-forms)
  - [4.2 Verb Forms (ಎಸಕಪದಗಳ ಪದರೂಪಗಳು)](#42-verb-forms)
  - [4.4–4.7 Finite and Non-Finite Forms](#44-47-finite-and-non-finite-forms)
  - [4.8 Noun Forms and Case Suffixes](#48-noun-forms-and-case-suffixes)

**Volume 2**

- [Chapter 5 — Verb Usage (ಎಸಕಪದಗಳ ಬಳಕೆ)](#chapter-5--verb-usage)
  - [5.1 Overview of Verb Forms and Auxiliaries](#51-overview-of-verb-forms-and-auxiliaries)
  - [5.2 Tense Reference (ಹೊತ್ತಿನ ಪತ್ತುಗೆ)](#52-tense-reference)
  - [5.3–5.5 Aspect, Modality, Negation](#53-55-aspect-modality-negation)
- [Chapter 6 — Noun Phrase Structure (ಪದಕಂತೆಗಳ ಇಟ್ಟಳ)](#chapter-6--noun-phrase-structure)
  - [6.1–6.3 Verb Arguments and Semantic Roles (ಪಾಂಗುಗಳು)](#61-63-verb-arguments-and-semantic-roles)
  - [6.4–6.6 Case Semantics](#64-66-case-semantics)
- [Chapter 7 — Simple Sentences (ಸುಳುಸೊಲ್ಲುಗಳ ರಚನೆ)](#chapter-7--simple-sentences)
  - [7.1–7.3 Basic Sentence Patterns](#71-73-basic-sentence-patterns)
  - [7.4–7.6 Adjuncts and Modifiers](#74-76-adjuncts-and-modifiers)
- [Chapter 8 — Complex Sentences (ಅಡಕ ಮತ್ತು ಜೋಡು ಸೊಲ್ಲುಗಳು)](#chapter-8--complex-sentences)
  - [8.1 Compound Sentences (ಜೋಡುಸೊಲ್ಲುಗಳು)](#81-compound-sentences)
  - [8.2 Embedded Clauses (ಅಡಕಸೊಲ್ಲುಗಳು)](#82-embedded-clauses)
  - [8.3 Topicalization and Focus (ಸ್ಥಾನ ಬದಲಾವಣೆ)](#83-topicalization-and-focus)
- [Chapter 9 — Writing and Speech (ಬರಹ ಮತ್ತು ಮಾತು)](#chapter-9--writing-and-speech)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol1-book#adhyAya-1) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#munnOTa)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol1-book#adhyAya-2) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#hesarupada-iTTaLa)
...
Section 2.5 covers all three major types of Kannada compound words (ಜೋಡುಪದ): *hesaru joDu* (noun-headed compounds), *esaka joDu* (verb-headed compounds), and *parice joDu* (qualifier-headed compounds). The section explains diagnostic tests for distinguishing true compounds from syntactic noun phrases (discussed in detail in Volume 2): compounds have unpredictable meaning, resist separate modification of their parts, and show phonological fusion. Subsections describe the sandhi changes that occur at compound boundaries and give examples of each structural type. The section also discusses the relationship between noun-noun compounds and noun phrases, showing how the difference between *kALu maNe* (a "footstool" — compound) and *kALa maNe* (a "black house" — noun phrase) hinges on both semantic and phonological properties.
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol1-book#adhyAya-3) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#uLida-pada-iTTaLa)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol1-book#adhyAya-4) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#padarUpa-iTTaLa)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol2-book#adhyAya-5) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#esaka-baLake)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol2-book#adhyAya-6) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#padakante-iTTaLa)
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol2-book) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#suLusoLLu-racane)
...
### 7.4–7.6 Adjuncts and Modifiers

Adjunct expressions — those that add information to a sentence without being required by the verb — are covered in sections 7.4–7.6. Temporal adjuncts (time expressions: *nagale* "today," *nALe* "tomorrow," *nAlu gaTTege* "at four o'clock") are discussed in relation to the tense system: temporal adverbs typically reinforce or specify the tense meaning already expressed by the verb suffix, but in indirect speech contexts they can conflict with the verb's tense form, creating apparent paradoxes that the section analyses carefully. Locative adjuncts (place expressions), manner adjuncts, and reason/cause adjuncts round out the discussion. Section 7.5 examines how multiple adjuncts are ordered relative to the required arguments and to each other, and what determines whether a given adjunct is "inside" or "outside" the core proposition. Section 7.6 covers implicature and presupposition — the implicit and presupposed meanings that accompany sentences — distinguishing *oLahurULu* (ಒಳಹುರುಳು, entailment/implicature) from *munnENike* (ಮುನ್ನೆಣಿಕೆ, presupposition), using tests based on negation and question-formation.
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol2-book) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#aDaka-jODu-soLLu)

### 8.1 Compound Sentences

Kannada *jODusollu* (ಜೋಡುಸೊಲ್ಲು, compound sentences) are formed by joining two or more simple sentences. Two structural mechanisms are available: (1) coordination using connective particles (*mattu* "and," *illave* "or," *Adare* "but"); and (2) the converb strategy, in which the final verb of the first clause is replaced by one of its connective (non-finite) forms, and the two clauses share subject or argument structure. The second mechanism is the dominant strategy in Kannada writing and is the focus of section 8.1. Bhat explains the key constraint on the converb-coordination strategy: when both clauses have an agent (*mADuga*) argument, both agents must be coreferential — the same individual must perform both actions. Violations of this co-referentiality constraint produce ungrammatical sentences. Examples demonstrating the constraint and its scope are worked through in detail.

### 8.2 Embedded Clauses

*ADakasollUgaLu* (ಅಡಕಸೊಲ್ಲುಗಳು, embedded/complex sentences) arise when one sentence is embedded inside another as a noun phrase, a qualifier, or an adverbial. Kannada has three main types of clausal embedding: (1) *udu-hesarurUpa* nominalised clauses (formed with the suffix *-uvudu*/*-dudU*) that function as subjects or objects of higher verbs — *rAju bareyuvudu* "Raju's writing / the fact that Raju writes"; (2) participial relative clauses where a verb in its participial (*-uva*, *-da*, *-ada*) form directly precedes and modifies a noun head — *rAju baredA pausta ka* "the book that Raju wrote"; (3) conditional clauses formed with the *bEDike* suffix *-dare* — *baredare* "if (one) writes." The section analyses the argument-structure relations between the embedded and main clauses, showing how the agent of an embedded clause can be expressed (or left implicit when it is coreferential with a main-clause argument).

### 8.3 Topicalization and Focus

Section 8.3 examines how Kannada sentences express *information structure* — the distinction between topic (what the sentence is about, *sthana badaLAvaNe*, ಸ್ಥಾನ ಬದಲಾವಣೆ, "position change / topicalization") and focus (the new information the sentence contributes). Because Kannada has relatively free word order, speakers can move a constituent from its canonical position to the sentence-initial position to mark it as the topic, or to immediately pre-verbal position to mark it as the focus. The topic and focus positions interact with the particle *-u* (ಉ) used for emphasis/contrast. The section also discusses *neLegolisu* (ನೆಲೆಗೊಳಿಸುವುದು, "grounding" or discourse anchoring): how sentences establish given information as common ground before introducing new information. These phenomena — topicalization, focus, and grounding — are characteristically discourse-level phenomena whose analysis requires going beyond the single sentence.
...
[ಕನ್ನಡ →](./07-kannaDa-barahada-sollarime-vol2-book) | [Eke →](./07-kannaDa-barahada-sollarime-kn-eke#baraha-mAtu)
