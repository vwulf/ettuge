...
| File | Contents |
|------|----------|
| `06-kalikenudi-matthu-nudikalike.md` | YouTube transcript — 197 lines, heavily corrupted |
| `06-kalikenudi-matthu-nudikalike-website.md` | Website content stub / URL record |
