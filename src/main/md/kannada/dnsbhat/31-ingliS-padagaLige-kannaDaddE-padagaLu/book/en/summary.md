---
title: "Kannada's Own Words for English Words — English Summary"
---
...
**Published:** 2008 (1st ed.); 2011 (2nd ed.)
**Publisher:** Bāshā Prakāshana, Billeshwara, Huncha, Tirthahalli
**Language:** Kannada (reformed *hosa baraha* script)
**Pages:** 487
**Source quality:** PDF (Nudi font → wx_decode.py conversion; English headwords partially garbled as `(cid:...)` artifacts; Kannada definitions mostly clean)

> [← Back to folder](./../../README.md) | Kannada raw text: [book/kn/raw.md](../kn/raw.md)
...
- [Foreword / Introduction](#foreword)
  - [1. What this dictionary is for](#sec-purpose)
  - [2. The triśaṅku word problem](#sec-trishanku)
  - [3. Word-formation principles](#sec-word-formation)
    - [3.1 Agent nouns: -gāra, -āḷi suffixes](#sec-agent)
    - [3.2 Action nouns: -ke, -ike, -ta, -vu suffixes](#sec-action)
    - [3.3 Negation without Sanskrit prefix *a-*](#sec-negation)
    - [3.4 Compound words and reduplication](#sec-compound)
  - [4. What makes this different from other dictionaries](#sec-difference)
- [The A–Z Dictionary](#dictionary)
  - [A](#dict-A)
  - [B](#dict-B)
  - [C through Z](#dict-CZ)
...
- The raw decoded file at [`../kn/raw.md`](../kn/raw.md) preserves all content as-is; a future OCR pass or manual correction could restore the garbled headwords
