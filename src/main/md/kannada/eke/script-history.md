...
2. Wikipedia: [Brahmi script](https://en.wikipedia.org/wiki/Brahmi_script)
3. Wikipedia: [Kadamba script](https://en.wikipedia.org/wiki/Kadamba_script) — transition from Brāhmī to early southern Indic scripts
