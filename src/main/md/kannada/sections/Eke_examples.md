...
halmiDi is transcribed into Eke here. Original is in kadamba kannaDa script which
is very different. In some ways it can be seen as between modern kannaDa and asokan/tamiZ brAhmi
and note that all script names are quite incidental. Most scripts were not referred to as such
