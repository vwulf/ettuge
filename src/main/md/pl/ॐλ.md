...
Alternate Computational Models [^34] that come up are:
1. SKI Calculus [^6]
2. Iota and Jot [^7]
...
One recent experiment that was interesting was how it was shown that LLMs can act as a computer [^35] and well summarized here [^37]. 
...
[^34]: https://en.wikipedia.org/wiki/Model_of_computation
[^35]: https://github.com/anadim/subleq-transformer/blob/main/round1_constructed/report.pdf
[^36]: https://en.wikipedia.org/wiki/One-instruction_set_computer
[^37]: https://x.com/DimitrisPapail/status/2028669695344148946?s=20
