...
This code https://github.com/vwulf/ettuge/blob/master/src/main/haskell/%E0%B2%95%E0%B2%B3%E0%B3%8D%E0%B2%B3.hs
was written to solve a problem from https://raymondsmullyan.com/books/the-riddle-of-scheherazade/
...
“True, Your Majesty,” replied Scheherazade, “but, to get on with my story, the thief joyfully came across a pile of diamonds. His first thought was to take them all, but
...
“There are two other versions of the story,” said Scheherazade. “According to a second version, each of the first four thieves took half of what he found plus two, instead of plus one, and again the fifth thief found none. According to this version, how many diamonds were originally in the pile?
...
---
While discussing this with a friend, there was some back and forth between version 1, 2 and 3 with a friend. So I thought this one would be a simple one to code - after going through a manual trace of version 1 while explaining.
...
[76,36,16,6,1]
```
Copilot does a decent job explaining the code.
...
In other words, I didn't have issues with catamorphisms. All other forms were outside my regular programming vocabulary. I found an excuse to use scanl to boraden it. Although I can see where I could apply some of the others, I have not found problem domains where I can intuitively come up with hylomorphisms or paramorphisms i.e. I have not understood it well enough.
...
So I mostly did renames of functions from the English to Kannada. The higher ordered functions give a very abstract feel. However the keywords being in English do take away some elegance. Chaning those requires digging a bit deeper.
...
This explains the strange combination of consonant + virama + full vowel instead of consonant + vowel modifier which is the standard way to type kannada. Some consonant + virama + consoonant combinations (ottaksharas) were parsed while others didn't. Other languages like Racket did better. However programming is a very limiting experience due to limited support of unicode on terminal emulators. So programs could fail to compile or link anywhere down the line.
