...
| [kannadadalle hosapadagalannu kaTTuva bage](influential/kannadadalle-hosapadagalannu-kattuva-bage.md) | D. N. Shankara Bhat's practical handbook for creating new Kannada vocabulary using the language's native Dravidian morphological resources. Documents the complete native Kannada word-formation system — three word classes (ಹೆಸರುಪದ, ಎಸಕಪದ, ಪರಿಚೆಪದ), two creation methods (ಕಟ್ಟುಪದ suffixation and ಜೋಡುಪದ compounding), and four prefix groups — and applies it affix-by-affix across 52 parts to show native Kannada equivalents for every English suffix and prefix. The primary source for the DNS Bhat word-formation methodology used in this repository. ([English summary →](../kannada/dnsbhat/02-kannadadalle-hosapadagalannu-kattuva-bage/02-kannadadalle-hosapadagalannu-kattuva-bage-en.md)) |
