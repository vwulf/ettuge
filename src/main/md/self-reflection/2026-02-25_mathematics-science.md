...
How hard is it to prove that problems are hard to solve? Meta-complexity theorists have been asking questions like this for decades.
www.quantamagazine.org
...
Greatness was always expected of Ken Ono. But as he struggled with his parents' expectations, he found solace and inspiration in the life of two-time college dropout — and mathematical genius.
www.quantamagazine.org
...
Gabriel Peyré (@gabrielpeyre): The divergence (both continuous and discrete) is (minus) the adjoint of the gradient (this is integration by part). Together with the Laplacian, they form the workhorses of many PDE and variational processing methods.
https://x.com/gabrielpeyre/status/1816699972789628992

Frank Nielsen (@FrnkNlsn): Great book for an introduction to topological data analysis
...
Multiplication on Soroban (Japanese Abacus, Jimmy Wu, YouTube)
https://youtu.be/ZiZ0VXf9Ar4

Division on Soroban (Japanese Abacus, Jimmy Wu, YouTube)
...
Matt Strassler explains that the origin of mass in the universe has a lot to do with music.
www.quantamagazine.org
...
Johannes Brandstetter (@jo_brandstetter): Lenny Susskind covers the mathematics of Riemannian spaces and tensor calculus to link gravity and geometry. Absolutely elegant and easy to understand.
https://x.com/jo_brandstetter/status/1802576302739775607

Massimo (@Rainmaker1973): Henri Poincaré proved the non-existence of the uniform first integral of the three-body problem. Yet, stable solutions do exist.
https://x.com/Rainmaker1973/status/1830309619966554272

Γ(z) (@gammaofzeta): There's not a single (descriptive) model of reality devoid of conceptual/cultural baggage (metaphysical framework).
...
Fermat's Library: More gold in Sun than water in oceans (proof)
...
Balanced boulders on San Andreas fault (livescience.com)
...
Anima Anandkumar wants computer scientists to move beyond the matrix.
www.quantamagazine.org
...
No hierarchy, infinitely curious, lazy to publish, ability to abstract into math while engineering, could ride unicycles (including off center one) and penny farthings. Juggled, wrote about the math of juggling, wanted a funeral with coffin carried by 6 unicyclists, has the law of entropy on the other side of his gravestone, grew a beard, took to running everyday in middle age, died of Alzheimer's. With Ed Thorpe, made the first wearable computer to win roulette, designed a (bouncing) juggling clown, a mouse to solve a maze, a chess robot that could do end games — before transistors, a Rubik's cube solver, lasted 42 moves against world number 1 chess player.
...
Alexander Grothendieck — isolated, some say his metaphysical theories could contain wonders.
www.theguardian.com
https://www.theguardian.com/science/article/2024/aug/31/alexander-grothendieck-huawei-ai-artificial-intelligence

Poincaré three-body problem (stable solutions exist despite non-existence of uniform first integral)

## From self-1.md (Oct 2024 – Feb 2026)

**Prime Number Distribution — New Results**
New progress on understanding the distribution of prime numbers; updates on Riemann Hypothesis-adjacent work.
quantamagazine.org — https://www.quantamagazine.org/...

**How Prime Numbers Become a Raga — Ulam Spiral**
Personal note on the Ulam spiral pattern and its connection to music theory.
en.wikipedia.org — https://en.wikipedia.org/wiki/Ulam_spiral

**Arches Geology — How Natural Arches Form (Jul 2025)**
Geological explanation of how sandstone arches form through differential erosion, joint widening, and rock fall.
youtube.com — https://www.youtube.com/watch?v=...

**Wolves and Ecosystem Restoration — Trophic Cascades (Sep 2025)**
How wolf reintroduction to Yellowstone changed river courses through trophic cascade effects on elk and vegetation.
youtube.com — https://www.youtube.com/watch?v=...

**GPT-5.2 Solves Physics Olympiad Problems (Feb 2026)**
Report on AI system achieving near-perfect scores on International Physics Olympiad problems.
arxiv.org — https://arxiv.org/abs/...

**Scientists Discover Fat-Burning Molecular Switch**
Research identifying a specific molecular receptor that triggers fat oxidation; potential obesity therapy target.
sciencedaily.com — https://www.sciencedaily.com/...

**Third State of Existence Beyond Life and Death**
Research identifying a biological state between life and death with distinct cellular activity patterns.
...
Study of precariously balanced rocks near the San Andreas Fault used to constrain historical earthquake magnitude.
livescience.com — https://www.livescience.com/...

**Centenarians Blood Differences (Aug 2025)**
Blood biomarker analysis of centenarians showing lower inflammation, glucose, and liver enzymes vs. normal elderly.
nature.com — https://www.nature.com/articles/...

**Blood of Exceptionally Long-Lived People**
Comprehensive blood profiling of supercentenarians; unique patterns in lipids, immune markers, and metabolic indicators.
nature.com — https://www.nature.com/articles/...

**Long COVID Blood Abnormalities (Nov 2025)**
Identification of persistent blood immune dysregulation, microclots, and protein anomalies in long COVID patients.
nature.com — https://www.nature.com/articles/...

**BNP as Cardiac Mortality Biomarker**
Research validating B-type natriuretic peptide as a strong independent predictor of cardiovascular death.
...
Genomic analysis revealing more complex ancestry for the Japanese population beyond the Yayoi/Jomon binary.
phys.org — https://phys.org/news/2024-08-dna-ancestry-people-japan.html

**Respiratory Viruses Reignite Dormant Cancer Cells**
Mechanism by which common respiratory viral infections can reactivate dormant cancer cells via immune signaling.
nature.com — https://www.nature.com/articles/...

**Type 4 Diabetes — New Classification (Sep 2025)**
Lean elderly individuals developing insulin resistance without obesity; distinct pathophysiology from types 1–3.
youtube.com — https://www.youtube.com/watch?v=...

**Playing Wind Instruments and Sleep Apnea**
Epidemiological study showing wind instrument players have lower rates of obstructive sleep apnea.
pubmed.ncbi.nlm.nih.gov — https://pubmed.ncbi.nlm.nih.gov/...

**DOSA Code — Obesity/Heart/Sleep Gene (Feb 2026)**
Discovery of a genetic variant (DOSA) linking susceptibility to obesity, cardiovascular disease, and sleep apnea.
youtube.com — https://www.youtube.com/watch?v=...

**Hippocampal Spatial Representations and Hyperbolic Geometry**
Research linking the geometry of hippocampal place cell activity to hyperbolic space; implications for navigation and memory.
arxiv.org — https://arxiv.org/abs/...

**Pancreatic Cancer and Sedentary Work (Dec 2025)**
Epidemiological study correlating prolonged sitting with elevated pancreatic cancer incidence.
...
Research documenting sustained hypertension in COVID-19 survivors months to years post-infection.
...
Research on myosteatosis: mechanism of intramuscular fat deposition, metabolic consequences, and exercise reversal.
pubmed.ncbi.nlm.nih.gov — https://pubmed.ncbi.nlm.nih.gov/...

**Valley Fever — Fungal Infection Range Expansion (Aug 2025)**
Coccidioidomycosis expanding geographic range due to climate change; identification, symptoms, and treatment.
