...
Books read, books in progress, reading lists, literary essays, and book-adjacent cultural commentary. Pulled from the `[→ books-literature]` routing hints in `miscellaneous.md`.

**Cross-links to other topic files:**
- Functional programming books → `scala-functional-programming.md`
- 21 AI books list → `machine-learning-ai.md`
- Science & nature writing → `mathematics-science.md`
- Kannada literature (Bhyrappa, Mohan, Sreedharettan) also → `kannada-language-linguistics.md`
...
A bare reference to Thomas Pynchon's sprawling 2006 novel — nearly 1,100 pages covering the period from the 1893 Chicago World's Fair through World War I, featuring anarchists, mathematicians, Zeppelin crews, and time travel. One of Pynchon's most ambitious (and challenging) works. **[→ books-literature]**

**Clarkesworld: Better Living Through Algorithms**
clarkesworldmagazine.com — <https://clarkesworldmagazine.com/kritzer_05_23/>

A Hugo Award-winning science fiction short story by Naomi Kritzer, published in Clarkesworld (2023). The story explores AI-assisted life coaching and algorithmic optimization of daily habits in a warmly humanist, lightly satirical way. **[→ books-literature; AI theme → machine-learning-ai]**
...
A tweet announcing or recommending Peggy Mohan's latest book on languages — Mohan is a Trinidad-born Indian linguist who writes accessibly about language, migration, and the Indic language family (*Wanderers, Kings, Merchants*). **[→ books-literature; linguistics → kannada-language-linguistics]**

**Sreedharettan: The Beedi Worker Who Dreamt of Dictionaries**
<https://youtu.be/KNXuGl5gAgU>

A documentary about Njattyela Sreedharan, a beedi (hand-rolled cigarette) factory worker from Kerala who spent his life self-educating and compiling Malayalam dictionaries — a remarkable story of autodidactic scholarship from outside academia. **[→ books-literature; linguistics/language → kannada-language-linguistics; documentary → arts-music-film]**
...
rand-rambler.blogspot.com — <https://rand-rambler.blogspot.com/2009/02/sl-bhyrappa-sakshi-quick-reflection.html?m=1>

A blog reflection on S. L. Bhyrappa's Kannada novel *Sākṣi* ("Witness"), which explores moral philosophy through the lens of the Mahabharata. Bhyrappa is considered the greatest living Kannada novelist. **[→ books-literature; Kannada literature → kannada-language-linguistics]**

---

## Functional Programming Books

*(Primary file: `scala-functional-programming.md`. Cross-listed here for the book-review angle.)*

**Dmitrii Kovanikov: "Domain Modelling Made Functional" review**
x.com — <https://x.com/ChShersh/status/1866943888558014897>

A tweet by Dmitrii Kovanikov (ChShersh), a prolific functional programming advocate, reviewing "Domain Modelling Made Functional" by Scott Wlaschin. The book applies functional programming concepts (F#) to domain-driven design. **[→ scala-functional-programming; or books-literature]**

**Dmitrii Kovanikov: "Functional Design and Architecture" review**
x.com — <https://x.com/ChShersh/status/1885055992951452089>

Another Kovanikov tweet reviewing "Functional Design and Architecture" by Alexander Granin — a book on building large Haskell applications using domain-driven design and architecture patterns. **[→ scala-functional-programming; or books-literature]**
...
"A truly magical real life story set in the Grand Canyon. Right up there with 'Barbarian days: A surfing life' in terms of best adventure book I've read!" (personal reflection, Oct 2025)
...
x.com — <https://x.com/johncrickett/status/2026288507312910547?s=20>

A tweet thread by John Crickett listing 21 books for learning AI from fundamentals to advanced topics, anchored by Chip Huyen's *AI Engineering*. A curated reading list for practitioners. **[→ machine-learning-ai; or books-literature]**
