...
export const EK_CONSONANTS = (
[{pos: "velar",         cons: [ಕ,'ಕ',ಗ,'ಗ','ಙ', ' '    ]},
 {pos: "palatal",       cons: [ಚ,'ಚ',ಜ,'ಜ','ಞ' , ' '   ]},
 {pos: "retroflex",     cons: [ಟ,'ಟ',ಡ,'ಡ',ಣ,  ' '      ]},
 {pos: "dental",        cons: [ತ,'ತ',ದ,'ದ',ನ, ' '       ]},
 {pos: "labial",        cons: [ಪ,'ಪ',ಬ,'ಬ',ಮ,, ' '      ]},
 {pos: "unordered 1",   cons: [ಯ ,' ' ,ರ,ರ,' ',' '    ]},
 {pos: "unordered 2",   cons: [ಲ,ಳ,ಳ,ವ, ' ' ,  ' '    ]},
 {pos: "unordered 3" ,  cons: [ಶ,ಶ,ಸ,ಹ, ' ' ,  ' '    ]},
 {pos: "unordered 4" ,  cons: [' ',' ',' ',' ',' ',' '  ]}
 ]
)

export const EK_VOWELS = ([
...
{position: 10, name:  "ay", 		char: "\u{0C85}\u{0CAF}\u{0CCD}",modifier:	"\u{0CAF}\u{0CCD}"	}	
{position: 11, name:  "o", 		char: "\u{0C92}", 		modifier:	"\u{0CCA}"		}
{position: 12, name:  "O", 		char: "\u{0C93}", 		modifier:	"\u{0CCB}"		}
{position: 13, name:  "av", 		char: "\u{0C94}\u{0CB5}\u{0CCD}",modifier:	"\u{0CB5}\u{0CCD}"	}
{position: 14, name:  "x", 		char: "\u{0CB0}\u{0CBF}",	modifier:"\u{0CCD}\u{0CB0}\u{0CBF}"	}
{position: 15, name:  "X", 		char: "\u{0CB0}\u{0CBF}",       modifier:"\u{0CCD}\u{0CB0}\u{0CBF}"	}
{position: 16, name:  "q", 		char: "\u{0CB2}\u{0CBF}",	modifier:"\u{0CCD}\u{0CB2}\u{0CBF}"	}
{position: 17, name:  "Q", 		char: "\u{0CB2}\u{0CBF}", 	modifier:"\u{0CCD}\u{0CB2}\u{0CBF}"	}
{position: 18, name:  "anusvAra", 	char: "\u{0C85}\u{0C82}", 	modifier:	"\u{0C82}"		}
{position: 19, name:  "visarga", 	char: "\u{0C85}\u{0C83}",	modifier:	""			}
{position: 20, name:  "virAma", 	char: "",  			modifier:	"\u{0CCD}"		}
{position: 21, name:  "chandrabindu", 	char: "",  			modifier:	""			}
