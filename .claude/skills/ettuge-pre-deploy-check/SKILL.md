...
description: >
  ...
  pages.yml, REFL_CATS, FP_ARTICLES, or adding/removing Reflection source files.
  Catches the class of errors that have recurred: editing the wrong _config.yml,
  missing source files, duplicate nav_order values, broken Python syntax in CI,
  search accidentally re-enabled. Trigger phrases: "sanity check", "pre-deploy check",
  "test before deploying", "check before pushing", "run the deploy check".
---
